...
const ITEMS = {
  ...
  treasureAmulet:{id:'treasureAmulet',name:'寻宝护符',type:'accessory',rarity:'B',effect:'掉落稀有度提升一级',desc:''},
  luckyFoot:  { id:'luckyFoot', name:'幸运兔脚',type:'accessory',rarity:'B',luk:6,desc:'' },
  giantBelt:{ id:'giantBelt',name:'巨人腰带',type:'accessory',rarity:'B',maxHp:40,desc:''},
  ...
  // 第五幕新增
  dragonScale:{id:'dragonScaleFrag',name:'龙鳞碎片',type:'material',rarity:'C',sellPrice:50,desc:'远古巨龙的鳞片碎片'},
...
const ENEMIES = {
  // 第一幕
  wolf:     { name:'灰狼',   hp:20, atk:4, def:1, spd:3, trait:null },
  snake:    { name:'毒蛇',   hp:14, atk:5, def:0, spd:6, trait:null },
  bandit:   { name:'山贼',   hp:24, atk:5, def:2, spd:4, trait:null },
  leeches:  { name:'水蛭群', hp:16, atk:4, def:0, spd:4, trait:'vampire' },
  spiderBoss:{ name:'洞穴巨蛛',hp:40, atk:6, def:2, spd:5, trait:'poison' },
  // 第二幕
  caveLizard:{ name:'洞穴蜥蜴',hp:30, atk:7, def:2, spd:4, trait:null },
  caveBeetle:{ name:'矿洞甲虫',hp:28, atk:8, def:3, spd:3, trait:'hardShell' },
  youngSpider:{name:'幼年蛛后',hp:32, atk:9, def:3, spd:5, trait:'poison2' },
  beetleKing:{name:'甲虫王',  hp:50, atk:10,def:5, spd:3, trait:'eliteBeetle' },
  rockWorm:  { name:'岩石巨虫',hp:65, atk:10,def:4, spd:4, trait:'acidArmor' },
  // 第三幕
  stoneGolem:{ name:'活化石像',hp:40, atk:11,def:5, spd:5, trait:'immune' },
  fireGuard: { name:'烈焰守卫',hp:38, atk:12,def:4, spd:6, trait:'burning' },
  curseGuard:{ name:'诅咒守卫',hp:42, atk:13,def:5, spd:5, trait:'curseAura' },
  ancientConstruct:{name:'古代构装体',hp:90,atk:14,def:6,spd:7,trait:'multiAttack'},
  // 第四幕
  riftCrawler:{name:'裂隙爬行者',hp:55,atk:16,def:7,spd:8,trait:'corrodeClaw'},
  voidSwordsman:{name:'虚空剑士',hp:60,atk:20,def:7,spd:9,trait:'pierceDef'},
  voidGuard:{name:'虚空守卫',hp:70,atk:16,def:10,spd:7,trait:'regen5'},
  voidSeer:{name:'虚空先知',hp:55,atk:18,def:6,spd:10,trait:'mindBlast'},
  riftWrath:{name:'裂隙之怒',hp:60,atk:20,def:8,spd:9,trait:'corrodeAura'},
  crystalScorpion:{name:'结晶巨蝎',hp:85,atk:22,def:9,spd:8,trait:'crystalArmor'},
  abyssLord:{name:'深渊之主',hp:120,atk:22,def:9,spd:9,trait:'abyssLord'},
  // 第五幕
  dragonGuard:{name:'龙裔守卫',hp:70,atk:23,def:10,spd:10,trait:'fireBreath2'},
  youngDragon:{name:'幼年火龙',hp:65,atk:24,def:9,spd:11,trait:'fireBreath3'},
  lavaElemental:{name:'熔岩元素',hp:80,atk:28,def:10,spd:9,trait:'lavaBurn'},
  ancientDragon:{name:'古龙之王',hp:160,atk:28,def:12,spd:11,trait:'dragonLord'},
  // 第六幕
  starAvatar:{name:'星尘化身',hp:90,atk:30,def:13,spd:14,trait:'starBurn'},
  voidBeast:{name:'虚空巨兽',hp:120,atk:35,def:14,spd:15,trait:'voidBeast'},
  fateAvatar:{name:'命运化身',hp:220,atk:38,def:16,spd:16,trait:'fateLord'},
};
